    ...
    <div class="navbar-nav">
        ...
        <div class="navbar-item navbar-user dropdown">
            <a
                ...
                @endif
                <span>
                    <span class="d-none d-md-inline">{{auth()->guard('paciente')->user()->nombre}}</span>
                    <b class="caret"></b>
                </span>
            </a>
            <div class="dropdown-menu dropdown-menu-end me-1">
                <a href="{{url('dashboardP')}}" class="dropdown-item">Calendar</a>
                <div class="dropdown-divider"></div>
                <a href="{{url('logoutP')}}" class="dropdown-item">Log Out</a>
            </div>
        </div>
    </div>
</div>