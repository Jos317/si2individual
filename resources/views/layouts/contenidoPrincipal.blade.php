<div id="content" class="app-content">
    ...
    <div class="row">
        ...
        <div class="col-xl-8">
            ...
            <ul
                class="nav nav-tabs nav-tabs-inverse nav-justified"
                data-sortable-id="index-2">
                <li class="nav-item">
                    <a href="#latest-post" data-bs-toggle="tab" class="nav-link active">
                        <i class="fa fa-camera fa-lg me-5px"></i>
                        <span class="d-none d-md-inline">Latest Post</span></a>
                </li>
                <li class="nav-item">
                    <a href="#purchase" data-bs-toggle="tab" class="nav-link">
                        <i class="fa fa-archive fa-lg me-5px"></i>
                        <span class="d-none d-md-inline">Purchase</span></a>
                </li>
                <li class="nav-item">
                    <a href="#email" data-bs-toggle="tab" class="nav-link">
                        <i class="fa fa-envelope fa-lg me-5px"></i>
                        <span class="d-none d-md-inline">Email</span></a>
                </li>
            </ul>
            <div
                class="tab-content panel rounded-0 rounded-bottom mb-20px"
                    ...
                    <div class="h-300px p-3" data-scrollbar="true">
                        <div class="d-sm-flex">
                            <a href="javascript:;" class="w-sm-200px">
                                <img
                                    ...
                                    src="{{asset('asset/img/gallery/gallery-1.jpg')}}"
                                    alt=""/>
                            </a>
                        ...
                        <div class="d-sm-flex">
                            <a href="javascript:;" class="w-sm-200px">
                                <img
                                    class="mw-100 rounded"
                                    src="{{asset('asset/img/gallery/gallery-10.jpg')}}"
                                    alt=""/>
                            </a>
                            <div class="flex-1 ps-sm-3 pt-3 pt-sm-0">
                        ...
                        <div class="d-sm-flex">
                            <a href="javascript:;" class="w-sm-200px">
                                <img
                                    class="mw-100 rounded"
                                    src="{{asset('asset/img/gallery/gallery-7.jpg')}}"
                                    alt=""/>
                            </a>
                            <div class="flex-1 ps-sm-3 pt-3 pt-sm-0">
                        ...
                        <div class="d-sm-flex">
                            <a href="javascript:;" class="w-sm-200px">
                                <img
                                    class="mw-100 rounded"
                                    src="{{asset('asset/img/gallery/gallery-8.jpg')}}"
                                    alt=""/>
                            </a>
                            <div class="flex-1 ps-sm-3 pt-3 pt-sm-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="hidden-sm text-center">
                                        <a href="javascript:;">
                                            <img src="{{asset('asset/img/product/product-1.png')}}" alt="" width="32px"/>
                                        </a>
                                    </td>
                                    <td class="text-nowrap">
                                        <h6>
                                            <a href="javascript:;" class="text-dark text-decoration-none">Nunc eleifend lorem eu velit eleifend,
                                                <br/>eget faucibus nibh placerat.</a>
                                        </h6>
                                    </td>
                                    <td class="text-blue fw-bold">$349.00</td>
                                    <td class="text-nowrap">
                                        <a href="javascript:;" class="text-dark text-decoration-none">Derick Wong</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="fw-bold text-muted">13/02/2021</td>
                                    <td class="hidden-sm text-center">
                                        <a href="javascript:;">
                                            <img src="{{asset('asset/img/product/product-2.png')}}" alt="" width="32px"/>
                                        </a>
                                    </td>
                                    <td class="text-nowrap">
                                        <h6>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-sm text-center">
                                        <a href="javascript:;">
                                            <img src="{{asset('asset/img/product/product-3.png')}}" alt="" width="32px"/>
                                        </a>
                                    </td>
                                    <td class="text-nowrap">
                                        <h6>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-sm text-center">
                                        <a href="javascript:;">
                                            <img src="{{asset('asset/img/product/product-4.png')}}" alt="" width="32px"/>
                                        </a>
                                    </td>
                                    <td class="text-nowrap">
                                        <h6>
                                ...
                                <tr>
                                    ...
                                    <td class="hidden-sm text-center">
                                        <a href="javascript:;">
                                            <img src="{{asset('asset/img/product/product-5.png')}}" alt="" width="32px"/>
                                        </a>
                                    </td>
                                    <td class="text-nowrap">
                                        <h6>
                    ...
                    <div class="h-300px p-3" data-scrollbar="true">
                        <div class="d-flex">
                            <a class="w-60px" href="javascript:;">
                                <img
                                    src="{{asset('asset/img/user/user-1.jpg')}}"
                                    alt=""
                        ...
                        <div class="d-flex">
                            <a class="w-60px" href="javascript:;">
                                <img
                                    src="{{asset('asset/img/user/user-2.jpg')}}"
                                    alt=""
                                    class="mw-100 rounded-pill"/>
                            </a>
                            <div class="flex-1 ps-3">
                                ...
                                <p class="mb-5px">
                                    ...
                                    porta leo. Pellentesque orci neque, tempor ornare purus nec, fringilla venenatis
                        ...
                        <div class="d-flex">
                            <a class="w-60px" href="javascript:;">
                                <img
                                    src="{{asset('asset/img/user/user-3.jpg')}}"
                                    alt=""
                                    class="mw-100 rounded-pill"/>
                            </a>
                            <div class="flex-1 ps-3">
                                ...
                                <p class="mb-5px">
                                    ...
                                    eros. Duis lacinia condimentum justo at ultrices. Phasellus sapien arcu,
                        ...
                        <div class="d-flex">
                            <a class="w-60px" href="javascript:;">
                                <img
                                    src="{{asset('asset/img/user/user-4.jpg')}}"
                                    alt=""
                                    class="mw-100 rounded-pill"/>
                            </a>
                            <div class="flex-1 ps-3">
                                ...
                                <p class="mb-5px">
                                    ...
                                    volutpat a dui vitae pulvinar. Nullam ligula mauris, dictum eu ullamcorper quis,
                                    lacinia nec mauris.
                                </p>
                                <span class="text-muted fs-11px fw-bold">Received on 04/16/2021, 12.39pm</span>
                            </div>
            ...
            <div class="panel panel-inverse" data-sortable-id="index-4">
                ...
                <hr class="m-0"/>
                <textarea
                    class="form-control rounded-0 border-0 shadow-none bg-light p-3"
                    ...
                    <div class="h-300px p-3" data-scrollbar="true">
                        <div class="d-flex">
                            <a href="javascript:;" class="w-60px">
                                <img
                                    src="{{asset('asset/img/user/user-5.jpg')}}"
                                    alt=""
                                    class="mw-100 rounded-pill"/>
                            </a>
                            <div class="flex-1 ps-3">
                        ...
                        <div class="d-flex">
                            <a href="javascript:;" class="w-60px">
                                <img
                                    src="{{asset('asset/img/user/user-6.jpg')}}"
                                    alt=""
                                    class="mw-100 rounded-pill"/>
                            </a>
                            <div class="flex-1 ps-3">
                        ...
                        <div class="d-flex">
                            <a href="javascript:;" class="w-60px">
                                <img
                                    src="{{asset('asset/img/user/user-8.jpg')}}"
                                    alt=""
                                    class="mw-100 rounded-pill"/>
                            </a>
                            <div class="flex-1 ps-3">
                        ...
                        <div class="d-flex">
                            <a href="javascript:;" class="w-60px">
                                <img
                                    src="{{asset('asset/img/user/user-7.jpg')}}"
                                    alt=""
                                    class="mw-100 rounded-pill"/>
                            </a>
                            <div class="flex-1 ps-3">
                ...
                <div class="table-responsive">
                    <table class="table table-panel align-middle mb-0">
                        ...
                        <tbody>
                            <tr>
                                <td nowrap="nowrap">
                                    <label class="badge bg-danger">Unique Visitor</label>
                                </td>
                                <td>13,203
                            ...
                            <tr>
                                <td nowrap="nowrap">
                                    <label class="badge bg-warning">Bounce Rate</label>
                                </td>
                                <td>28.2%</td>
                                <td>
                            ...
                            <tr>
                                <td nowrap="nowrap">
                                    <label class="badge bg-success">Total Page Views</label>
                                </td>
                                <td>1,230,030</td>
                                <td>
                            ...
                            <tr>
                                <td nowrap="nowrap">
                                    <label class="badge bg-blue">Avg Time On Site</label>
                                </td>
                                <td>00:03:45</td>
                                <td>
                            ...
                            <tr>
                                <td nowrap="nowrap">
                                    <label class="badge bg-default text-gray-900">% New Visits</label>
                                </td>
                                <td>40.5%</td>
                                <td>
                            ...
                            <tr>
                                <td nowrap="nowrap">
                                    <label class="badge bg-gray-900">Return Visitors</label>
                                </td>
                                <td>73.4%</td>
                                <td>
